...
viewBanner : Html msg
viewBanner =
    div [ class "w-full bg-emerald-600 text-white p-8" ]
        [ div [ class "text-center" ]
            [ h1 [ class "text-shadow font-bold text-xxl shadow-gray-500" ] [ text "conduit" ]
...
globalFeed =
    ( "Recent articles", ClickedTab GlobalFeed )
    ...
    let
        ...
        request =
            case feedTabs of
                ...
                GlobalFeed ->
                    Api.get (Endpoint.posts params) maybeCred decoder
