...
{-| The author of an Post. It includes a Profile.
        ...
        IsAnonymous ->
            let
                name =
                    "anon"
            in
            case Decode.decodeString Username.decoder ("\"" ++ name ++ "\"") of
                Ok n ->
                    n

                Err err ->
                    Debug.todo ("Error decoding Username from \"" ++ name ++ "\": " ++ Decode.errorToString err)
