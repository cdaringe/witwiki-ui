...
import Page.Post.Editor as Editor
...
view model =
    ...
    case model of
        ...
        Article article ->
            viewPage Page.Other GotArticleMsg (Post.view article)
...
subscriptions model =
    case model of
        ...
        Article article ->
            Sub.map GotArticleMsg (Post.subscriptions article)
