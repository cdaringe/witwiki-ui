...
viewHeader page maybeViewer =
    nav [ class "px-4 py-4 inline-block flex items-center" ]
        [ a [ class "inline flex-1 font-bold text-lg text-emerald-500", Route.href Route.Home ]
            [ text "witwiki" ]
        , ul [ class "inline flex m-0 gap-x-4" ] <|
